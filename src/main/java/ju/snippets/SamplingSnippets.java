...
//    }
    ...
    RealDistribution distro, double bound) {
        return sampleAboveBound(distro, bound, Integer.MAX_VALUE);
    }
    
    public static double sampleBelowBound(
    RealDistribution distro, double bound) {
        return sampleBelowBound(distro, bound, Integer.MAX_VALUE);
    }
    
    public static double sampleWithinBounds(
    RealDistribution distro, double lower, double upper) {
        return sampleWithinBounds(distro, lower, upper, Integer.MAX_VALUE);
    }
    
    public static double sampleAboveBound(
    RealDistribution distro, double bound, int attempts) {
    ...
    public static double sampleWithinBounds(
    RealDistribution distro, double lower, double upper, int attempts) {
    ...
    public static double sampleAboveBound(
    IntegerDistribution distro, double bound) {
        return sampleAboveBound(distro, bound, Integer.MAX_VALUE);
    }
    ...
    public static double sampleWithinBounds(
    IntegerDistribution distro, double lower, double upper) {
        return sampleWithinBounds(distro, lower, upper, Integer.MAX_VALUE);
    }
    
    public static double sampleAboveBound(
    IntegerDistribution distro, double bound, int attempts) {
        return sampleWithinBounds(distro, bound, Double.POSITIVE_INFINITY, attempts);
    }
    ...
    public static double sampleWithinBounds(
    IntegerDistribution distro, double lower, double upper, int attempts) {
